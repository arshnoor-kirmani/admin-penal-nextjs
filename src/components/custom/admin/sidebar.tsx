...
export default function sidebar() {
  const [instituteInfo, setInstituteInfo] = React.useState<{
  ...
  const [fetchingInfo, setFetchingInfo] = React.useState(true);
  React.useEffect(() => {
      ...
      try {
        const response = await axios
          .post("/api/auth/get-institute-info", {
            identifier: "skjansewakendra86+18@gmail.com",
          })
          .then((res) => {
            ...
            if (res.data.success) {
              setInstituteInfo({
                ...
                institute_id: res.data.user.institute_id,
